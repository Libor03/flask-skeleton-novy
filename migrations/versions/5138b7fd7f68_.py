...
Revision ID: 5138b7fd7f68
Revises: None
Create Date: 2020-09-24 11:33:38.016985

"""

# revision identifiers, used by Alembic.
revision = '5138b7fd7f68'
down_revision = None
...
def upgrade():
    ...
    sa.Column('firma_zkratka', sa.String(length=8), nullable=False),
    sa.Column('jmenovita_hodnota', sa.Float(), nullable=False),
    ...
    op.create_index('ix_stock_firma_zkratka', 'stock', ['firma_zkratka'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_stock_firma_zkratka', table_name='stock')
